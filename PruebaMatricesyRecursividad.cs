...
int[] nivel = [30];
int poke1, poke2, poke3, poke4 = 0;
string[,] equipoR = new string[6, 3];
string[,] equipoV = new string[6, 3];
string[,] equipoA = new string[6, 3];
string[,] equipoY = new string[6, 3];
...
for (int x = 0; x < 6; x++)
{
    for (int i = 0; x < 3; x++)
    {
        ...
        poke1 = random.Next(0, 151);
        equipoR[x, 0] = pokemones[poke1];
        equipoR[i, 1] = tipo[poke1];
    }
...
for (int x = 0; x < 6; x++)
{
    for (int i = 0; i < 3; i++)
    {
        poke2 = random.Next(50, 81);
        equipoR[x, 2] = nivel[poke2];
